...
public class K3sVersityTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    private static final String JVM_ENVIRONMENT_KEY = K3sVersityTestResource.class.getName() + ".jvm-environment";
